...
%% Ex 4 different starting points
...
title('Backup energy obtained from different starting points')
...
fval_multi = (fval1+fval2+fval3+fval4+fval5+fval6)/6;
multi_time = toc;
...
title('T_{w3}')
set(gcf,'color','w');
title('All 4 states with the air flow rates constraint')
